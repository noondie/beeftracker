 ...
 * Juan Linietsky
 **/
class Instrument_Edit : public QHBoxLayout
{
	...
	class ListviewItem //TODO_2018 : public  QListViewItem 
	{
        	int id;
	...
	public:
		...
		ListviewItem( QListView * p_parent ) /* TODO2018 :  Q3ListViewItem(p_parent)*/ {}
	...
	QHBoxLayout * instrument_general_hbox;
	QVBoxLayout * instrument_volume_vbox;
	QVBoxLayout * instrument_pan_vbox;
	QVBoxLayout * instrument_pitchfilter_vbox;
...
protected slots:
	...
	void item_selected_cbk(/*TODO_2018 Q3ListViewItem *p_item*/);
	void item_renamed_cbk(/*TODO_2018  Q3ListViewItem * item,*/ int col );
