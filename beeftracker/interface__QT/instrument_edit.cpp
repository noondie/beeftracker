...
void Instrument_Edit::load_instrument() 
{
	...
	QString fn; // TODO_2018  = QFileDialog::getOpenFileName( QString::null, "Instrument Files (*.ci *.CI *.ii *.II *.xi *.XI)", this );

	if (fn.isEmpty())
		return; //nothing


	file_manager->load_instrument( "TODO_2018 fn", selected_instrument );
...
void Instrument_Edit::save_instrument() {
	...
	QString s; /* TODO_2018  = QFileDialog::getSaveFileName(
			QString::null,
...
/* TODO_2018 
        ...
        if ( file_manager->save_instrument( "TODO_2018 s" , selected_instrument ) ) {
		/* TODO_2018 QMessageBox::warning( this, "Oops!","Error saving instrument!","Ok");
		return ; */
	}
...
///
void Instrument_Edit::item_selected_cbk(/* TODO_2018 Q3ListViewItem *p_item*/) 
{
#ifdef TODO_2018 
...
void Instrument_Edit::set_selected_instrument(int p_which) {
	...
	// TODO_2018 instrument_list->setSelected(instrument_items[p_which],true);
}


void Instrument_Edit::item_renamed_cbk( /*TODO_2018 Q3ListViewItem * p_item,*/ int col ) 
{
#ifdef _TODO_2018_
	ListviewItem * item = dynamic_cast<ListviewItem *>(p_item);
	if (item==NULL) {
...
void Instrument_Edit::update_selected_instrument() {
	...
	// TODO_2018 nna.nna_group->setButton(inst->NNA_type);
	// TODO_2018 nna.dct_group->setButton(inst->duplicate_check_type);
	// TODO_2018 nna.dct_group_action->setButton(inst->duplicate_check_action);
...
/// ctor
Instrument_Edit::Instrument_Edit(QWidget *p_parent) : QHBoxLayout(p_parent)  
{
...
#ifdef _TODO_2018_
	QVBoxLayout * instr_props_aux_vbox; // TODO_2018  = new QVBoxLayout(this);
